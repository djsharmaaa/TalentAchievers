  ...
  <Col md={11} className="text-end">
    <nav aria-label="breadcrumb" className="custom-breadcrumb">
      <ol className="breadcrumb mb-0">
        ...
        <li className="breadcrumb-item active" aria-current="page">NCERT Solution</li>
      </ol>
    </nav>
  </Col>
</Row>
          ...
          <Row className='my-4'> 
            ...
            <SubjectCard linkTo="/Academics/Tweleth/NCERTSolution/TextbookSubject"  imgSrc='/images/p.png' imgAlt='physics' title='Physics' text='Class 12 NCERT Solution' />
